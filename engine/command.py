...
commands = {
    ...
    ("play on youtube", "play something on youtube", "youtube please","play on youtube", "play something on youtube", "youtube please","play on youtube", "play something on youtube", "youtube please"): "youtube",
    ...
    ("create folder","create folder","create folder","create folder","create folder", "make directory", "new folder"): "create_folder",
    ...
    ("switch between windows","switch between windows", "switch between windows", "switch between windows", "change active window", "switch application","switch between windows", "change active window", "switch application","switch between windows", "change active window", "switch application"): "switch_between_windows",
    ...
    ("restore down","restore down", "restore down", "restore window down", "minimize and resize"): "restore_down",
    ("move window left","move window left","move window left", "shift window left"): "move_window_left",
    ("move window right","move window right", "move window right", "shift window right"): "move_window_right",
    ("switch to next window","switch to next window","switch to next window", "next window", "move to next window"): "switch_to_next_window",
    ("switch to previous window","switch to previous window", "switch to previous window", "previous window", "move to previous window"): "switch_to_previous_window",
    ("open task manager","open task manager","open task manager", "launch task manager", "start task manager"): "open_task_manager",
    ("lock screen","lock screen","lock screen", "lock workstation", "lock computer screen","lock screen", "lock workstation", "lock the computer","lock the computer"): "lock_screen",
    ("switch virtual desktop left","switch virtual desktop left", "switch virtual desktop left" "move to left virtual desktop", "go to left desktop"): "switch_virtual_desktop_left",
    ("switch virtual desktop right","switch virtual desktop right","switch virtual desktop right" "move to right virtual desktop", "go to right desktop"): "switch_virtual_desktop_right",
    ("minimize all windows", "minimize every window", "show desktop"): "minimize_all_windows",
    ("show desktop","show desktop","show desktop", "show all windows"): "show_desktop",
    ...
    ("open run dialog","open run dialog","open run dialog", "launch run dialog", "start run dialog"): "open_run_dialog",
    ("open action center","open action center","open action center" "launch action center", "start action center"): "open_action_center",
    ("open settings","open settings","open settings", "launch settings", "start settings"): "open_settings",
    ...
    ("open magnifier","open magnifier","open magnifier", "launch magnifier", "start magnifier"): "open_magnifier",
    ("open narrator", "launch narrator", "start narrator"): "open_narrator",
    ("open on-screen keyboard","open on-screen keyboard","open on-screen keyboard", "launch on-screen keyboard", "start on-screen keyboard"): "open_on_screen_keyboard",
    ...
    ("open control panel","open control panel","open control panel", "launch control panel", "start control panel"): "open_control_panel",
    ("open device manager","open device manager","open device manager", "launch device manager", "start device manager"): "open_device_manager",
    ("open disk management","open disk management","open disk management", "launch disk management", "start disk management"): "open_disk_management",
    ("open event viewer", "launch event viewer", "start event viewer"): "open_event_viewer",
    ("open performance monitor","open performance monitor","open performance monitor", "launch performance monitor", "start performance monitor"): "open_performance_monitor",
    ("open power options","open power options","open power options", "launch power options", "start power options"): "open_power_options",
    ("open programs and features", "launch programs and features", "start programs and features"): "open_programs_and_features",
    ("open system information","open system information","open system information", "launch system information", "start system information"): "open_system_information",
    ("open task scheduler","open task scheduler","open task scheduler", "launch task scheduler", "start task scheduler"): "open_task_scheduler",
    ("open disk cleanup","open disk cleanup","open disk cleanup", "launch disk cleanup", "start disk cleanup"): "open_disk_cleanup",
    ...
    ("open taskbar settings","open taskbar settings","open taskbar settings", "launch taskbar settings", "start taskbar settings"): "open_taskbar_settings",
    ("open system settings", "launch system settings", "start system settings"): "open_system_settings",
    ("open network settings","open network settings","open network settings", "launch network settings", "start network settings"): "open_network_settings",
    ...
    ("open time and language settings","open time and language settings","open time and language settings", "launch time and language settings", "start time and language settings"): "open_time_and_language_settings",
    ...
    ("turn on wifi","turn on wifi","turn on wifi", "enable wifi", "activate wifi"): "turn_on_wifi",
    ("turn off wifi","turn off wifi","turn off wifi", "disable wifi", "deactivate wifi"): "turn_off_wifi",
    ("turn on darkmode","turn on darkmode","turn on darkmode","turn on darkmode", "enable dark mode", "activate dark mode"): "turn_on_darkmode",
    ("turn off darkmode","turn off darkmode", "turn off darkmode", "turn off darkmode", "turn off darkmode",  "disable dark mode", "deactivate dark mode"): "turn_off_darkmode",
...
def allCommands(message=1):
    ...
    try:
        ...
        if intent == "time_now" and "time" in query:
            ...
            weather(query)
        elif intent == "camera" and "take" or "camera" in query:
        ...
        elif intent == "lock_screen" and "lock" in query:
        ...
        elif intent ==  "open_on_screen_keyboard" and "keyboard" in query:
        ...
        elif intent ==  "turn_on_darkmode"  and "on dark" in query:
            from engine.features import set_dark_mode
            set_dark_mode(True)

        elif intent ==  "turn_off_darkmode" and "off dark" in query:
            from engine.features import set_dark_mode
            set_dark_mode(False)
        ...
        elif intent ==  "increase_display_brightness" and "increase brightness" in query:
            from engine.features import increase_display_brightness
            increase_display_brightness()

        elif intent ==  "decrease_display_brightness" and "decrease brightness" in query:
            from engine.features import decrease_display_brightness
            decrease_display_brightness()
        elif intent ==  "question" in query:
